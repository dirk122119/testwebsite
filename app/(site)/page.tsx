          ...
          <div style={{ position: 'relative', width: '1200px' }}>
            <Box sx={{ flexGrow: 1,padding:"20px" }}>
              <Grid container spacing={2} >
                <Grid item xs={6} sx={{ maxWidth: "100%", display: "flex", justifyContent: "center" }}>
                ...
                <Grid item xs={6} sx={{ maxWidth: "100%", display: "flex",justifyContent:"center", alignItems: "center" }}>
            ...
            <Box sx={{ flexGrow: 1,padding:"20px" }}>
              <Grid container spacing={2} >
                <Grid item xs={6} sx={{ maxWidth: "100%", display: "flex", justifyContent: "center" }}>
                  ...
                  <Grid container spacing={2} sx={{width:"100%"}} >
                  {videoDirs.slice(0, 4).map((videoDir) => (
                      <>
                        <Grid item xs={8} sx={{ width: "100%", display: "flex", justifyContent: "center" }}>
                          <PostCard img={videoDir.image} name={videoDir.name} id={videoDir._id} class={videoDir.class} link="videoDirs" tag="innerLink" height='10vw'/>
                        </Grid>
                      </>
                    ))}
                  </Grid>
